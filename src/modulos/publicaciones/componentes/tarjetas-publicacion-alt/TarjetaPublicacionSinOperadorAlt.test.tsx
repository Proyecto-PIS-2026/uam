...
import TarjetaPublicacionSinOperadorAlt from "./TarjetaPublicacionSinOperadorAlt";
...
describe("TarjetaPublicacionSinOperadorAlt", () => {
  it("muestra el producto y sus características sin el nombre del operador", () => {
    render(
      <TarjetaPublicacionSinOperadorAlt
  ...
  it("actualiza el contenido y el callback cuando cambia la publicación", () => {
    ...
    expect(screen.queryByText("Huerta Sur")).not.toBeInTheDocument();
    expect(screen.queryByText("Frutas Norte")).not.toBeInTheDocument();
